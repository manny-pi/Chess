...
def testBlock(): 
    ...
    pygame.display.set_caption("oblock_test")
    FRAMES_PER_SECOND = 10
    frames_passed = 0 

    # Create I-Block to test 
    i_init_x, i_init_y = 200, 200
    oblock = OBlock(i_init_x, i_init_y, Color.BLUE, Orientation.UP, 0)
    print(repr(oblock))
    ...
    while running: 
        ...
        # Render graphics 
        # - - - - - - - - - - 
        for block in oblock:     # Render Oblock graphic
